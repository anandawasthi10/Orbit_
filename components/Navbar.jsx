...
import { Users, LayoutDashboard, CheckSquare, MessageSquare, LogOut, User, ShieldCheck, Sparkles } from 'lucide-react';
            ...
            {loading ? (
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  {session.user.profileComplete ? 'Edit Profile' : 'Complete Profile'}
                </Link>

                <div className="flex items-center gap-2.5 pl-2 border-l border-white/10">
                  <UserAvatar src={session.user.avatarUrl} name={session.user.name} />
