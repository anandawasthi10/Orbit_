...
function MemberAvatar({ src, name, size = 'w-10 h-10' }) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto pt-2">
          ...
          <div className="saas-card bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-5 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-slate-900">Create a Team</h2>
                      ...
                      >
                        ...
                        <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-600 font-medium">
                          <span className="flex items-center gap-1 text-slate-500">
                            ...
                            Joined {new Date(m.joinedAt).toLocaleDateString('en-GB', { day: 'numeric', month: 'short' })}
                          </span>
                        </div>
                      </div>
                    );
