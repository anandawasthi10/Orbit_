...
export default function ResourcesPage() {
  ...
  const grouped = CATEGORIES.reduce((acc: Record<string, IResource[]>, cat) => {
            ...
            return (
              <div key={category} className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {items.map((res) => {
                    const addedByObj = typeof res.addedBy === 'object' ? res.addedBy : null;
                    const addedByName = addedByObj?.name || 'Workspace Member';
                    const avatarUrl = addedByObj?.avatarUrl || '';
