    ...
    <div className="w-full max-w-md">
      <div className="glass-card rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <p className="text-sm text-slate-400 mt-1">Create your account to join your workspace team</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
          ...
          >
            {loading ? (
              ...
              <>
                <span className="flex-1 text-center pl-4">Create Account & Continue</span>
