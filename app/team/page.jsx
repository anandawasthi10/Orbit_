...
import { Mail, Calendar, CheckCircle2, UserX, Loader2, Sparkles } from 'lucide-react';
import TopHeader from '@/components/TopHeader';

function MemberAvatar({ src, name, size = 'w-12 h-12' }) {
            ...
            >
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-700 font-medium">
                ...
                <span className="flex items-center gap-1 text-[11px] text-slate-600 font-semibold shrink-0">
                  ...
                  Joined {new Date(member.createdAt).toLocaleDateString('en-GB', { month: 'short', year: '2-digit' })}
                </span>
              </div>
            </div>
          ))}
